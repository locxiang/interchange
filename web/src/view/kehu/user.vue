  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      <el-table :data="tableData">
        ...
        <el-table-column align="left" label="客户名称" min-width="100" prop="nickName" >
          <template #default="scope">
        ...
        <el-table-column align="left" label="登录账号" min-width="150" prop="userName" />
